...
namespace CauriLand\Crypto\Transactions;

use CauriLand\Crypto\Configuration\Network;
use CauriLand\Crypto\Enums\TypeGroup;
use CauriLand\Crypto\Transactions\Types\Transaction;
...
class Serializer
{
     ...
     *
     * @param \CauriLand\Crypto\Transactions\Types\Transaction $transaction
     */
